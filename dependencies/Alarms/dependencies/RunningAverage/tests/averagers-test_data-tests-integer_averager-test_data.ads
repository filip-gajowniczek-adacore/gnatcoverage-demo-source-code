...
with RunningAverage.Test_Data;
with RunningAverage.Test_Data.Tests;

package Averagers.Test_Data.Tests.Integer_Averager.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Averagers.Integer_Averager.Test_Data (Test);
